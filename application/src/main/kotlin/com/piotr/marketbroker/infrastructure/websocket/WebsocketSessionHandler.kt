...
class WebsocketSessionHandler(val applicationEventPublisher: ApplicationEventPublisher) : TextWebSocketHandler() {
    ...
    override fun handleTextMessage(session: WebSocketSession, message: TextMessage) {
        try {
            ...
            val m: WebsocketDTO = mapper.readValue(msg, WebsocketDTO::class.java)
...
*/
    ...
    fun sendMsg(message: String) {
        ...
        try {
            ...
            // TODO Auto-generated catch block
            log.error("Websocket sendMessage failed!")
            log.error(message)
        }
    }

    fun disconnect() {
        log.info("Websocket disconnect request")
        try {
            clientSession?.close()
        } catch (e: IOException) {
            // TODO Auto-generated catch block
